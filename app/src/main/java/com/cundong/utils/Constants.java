...
public class Constants {
	...
	public static final String MY_OLD_APK_PATH = PATH + "app-1.6.apk";
	public static final String MY_NEW_APK_PATH = PATH + "app-1.7.apk";
	public static final String MY_PATCH_APK_PATH = PATH + "diff.patch";
