...
public class ThumbActivity extends ToolbarActivity {
    ...
    private String getUrl(Integer pageNo) {
        ...
        Uri.Builder builder = Uri.parse(ConfigUtils.getBaseUrl() + "/api/v1/thumb/listForMobile?").buildUpon();
        ...
        MyVolley.addRequest(new JsonObjectRequest(getUrl(pageNo),
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        List<Thumb> thumbList = GsonUtils.parseThumbList(thumbJSONArray.toString());
                        thumbAdapter.setThumbList(thumbList);
        ...
        MyVolley.addRequest(new JsonObjectRequest(getUrl(pageNo + 1),
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        JSONArray thumbJSONArray = JSONUtils.getJSONArray(response, "content", null);
                        List<Thumb> thumbList = GsonUtils.parseThumbList(thumbJSONArray.toString());
                        thumbAdapter.getThumbList().addAll(thumbList);
                        thumbAdapter.notifyDataSetChanged();
                        checkLastPage(response);
                    }
                },
